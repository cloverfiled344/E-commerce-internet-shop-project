# import sys  !These imports for checking upload images!
...
class Smartphone(Product):
    ...
    accum_volume = models.CharField(max_length=255, verbose_name='Объем батереи')
    ram = models.CharField(max_length=255, verbose_name='Оперативная память')
...
class Customer(models.Model):
    user = models.ForeignKey(User, verbose_name='Ползовател', on_delete=models.CASCADE)
